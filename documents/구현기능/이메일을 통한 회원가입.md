...
예제를 위해 db에 cat@gmail.com 메일을 갖는 계정을 등록하고 진행했습니다<br/>. 
...
서버단에서 db 조회 후 true/false로 이용할 수 있는지 여부를 반환해줍니다<br/>. 
...
```  
<br/>
해당 이메일을 db에서 조회하기위해 작성한 쿼리문은 아래와 같습니다<br/>  
...
이 링크를 클릭할 시 컨트롤러에서 검증을 하고, 해당 회원을 정회원으로 등록해줍니다<br/>  
...
```
<br/> 
아래는 실제로 repository를 통해 db에 crud를 실행하는 memberService의 코드입니다<br/>  
